...
from __utils__ import is_torch2_available
if is_torch2_available():
    from face_attention_processor import FaceAttnProcessor2_0 as FaceAttnProcessor, AttnProcessor2_0 as AttnProcessor, CNAttnProcessor2_0 as CNAttnProcessor
else:
